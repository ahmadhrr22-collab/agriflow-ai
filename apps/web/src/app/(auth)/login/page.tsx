    ...
    <div className="min-h-screen flex" style={{background: 'var(--muted)'}}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12"
        ...
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6"
            ...
            <div className="w-1.5 h-1.5 rounded-full" style={{background: '#97C459'}}></div>
            <span className="text-xs" style={{color: 'rgba(255,255,255,0.7)'}}>
              Platform Kecerdasan Pangan Indonesia
            </span>
          </div>
          <h1 className="text-3xl font-medium text-white leading-tight mb-4">
            Distribusi pangan<br />yang lebih cerdas.
          </h1>
          <p className="text-sm leading-relaxed" style={{color: 'rgba(255,255,255,0.6)'}}>
            Data supply chain real-time, prediksi demand 7 hari,
            dan deteksi anomali harga untuk pengambilan keputusan
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-xl font-medium mb-1">Masuk ke dashboard</h2>
          ...
          <p className="text-xs mt-6 text-center" style={{color: 'var(--muted-foreground)'}}>
            Butuh akses?{' '}
            <span className="font-medium cursor-pointer" style={{color: '#166534'}}>
