  ...
  return (
    <div className="flex items-center justify-between px-4 py-2.5 rounded-xl text-sm"
      ...
      <div className="flex items-center gap-2.5">
        ...
        <span style={{color: '#3B6D11'}}>Sumber: Panel Harga Kementan, BMKG</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          <span style={{color: '#3B6D11'}}>Confidence</span>
          <div className="w-20 h-1.5 rounded-full overflow-hidden" style={{background: '#C0DD97'}}>
            <div className="h-full rounded-full" style={{width: '85%', background: '#166534'}}></div>
          </div>
          <span className="font-medium" style={{color: '#27500A'}}>85%</span>
        </div>
